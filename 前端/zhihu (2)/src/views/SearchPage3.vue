    ...
    <keep-alive>
        <div id="main" class="body" @click="HideHistory">
            ...
            <div id="search" class="search">
                <el-input v-model="InputValue" placeholder="请输入搜索内容" @click.stop="ShowHistory" @input="SearchShow">
                    <template #suffix>
            ...
            <div id='history' class="history" v-show="historyshow" @click.stop="ShowHistory">
                <el-table v-bind:data="InputListShow" stripe ref="multipleTable" @selection-change="handleSelectionChange" max-height="300">
